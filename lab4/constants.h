...
const int MAXSIZE = 12;     // amount of integers in the file (you need this to declare your array size)
const std::string FILENAME = "mytest.txt";    // The file name with the integers
